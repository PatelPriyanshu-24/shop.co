  ...
  <div className='NewArrivals' id='NewArrivals'>
    ...
    <Row xs={1} md={4} className="g-4">
      {NewArrivals.map((idx) => (
        <Col key={idx}>
          <Card >
            <Card.Img variant="top" src={idx.url} height={295} width={290}/>
            <Card.Body>
    ...
    <div className='button'><Button variant="dark">VIEW ALL</Button></div>
  </div>
 ...
 <div className='NewArrivals' id='Topsaleing'>
    ...
    <Row xs={1} md={4} className="g-4">
      {Topselling.map((idx) => (
        <Col key={idx}>
          <Card >
            <Card.Img variant="top" src={idx.url} height={295} width={20}/>
            <Card.Body>
              <Card.Title>{idx.name}</Card.Title>
              <Card.Text>
                <span>{idx.rating}</span>
   ...
   <div className='container2'>
    <div className='c2a'><h1 className='header2'>BROWSE BY DRESS STYLE</h1></div>
    <div className='c2b'>
    <Container>
    <Row className='DSrow'>
        <Col>
          <div className='DScol1'><h2 className='DStext'>Casual</h2></div>
        </Col>
        <Col>
          <div className='DScol2'><h2 className='DStext'>Formal</h2></div>
        </Col>
      </Row>
    </Container>
    <Container>
    <Row className='DSrow'>
        <Col >
          <div className='DScol3'><h2 className='DStext'>Party</h2></div>
        </Col>
        <Col>
          <div className='DScol4'><h2 className='DStext'>Gym</h2></div>
        </Col>
      </Row>
    </Container>
    </div>
